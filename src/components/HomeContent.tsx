              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-xl font-semibold text-gray-800 dark:text-white">Company Profile Biostark-AI</h3>
                      <div className="flex space-x-2">
                        <span className="px-2 py-1 text-xs font-medium bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200 rounded-full">Laravel</span>
                        <span className="px-2 py-1 text-xs font-medium bg-cyan-100 dark:bg-cyan-900 text-cyan-800 dark:text-cyan-200 rounded-full">TailwindCSS</span>
                      </div>
                    </div>
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      This is the company profile website for Biostark-AI, a company that provides a wide range of medical devices.
                    </p>
                    <div className="flex items-center justify-between">
                      <a href="https://biostark-ai.com/" className="text-blue-600 dark:text-blue-400 hover:underline text-sm font-medium">View Project →</a>
                      <div className="flex space-x-2">
                        <a href="https://biostark-ai.com/" className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200">
                ...
                >
                  <ProjectImage 
                    src="https://raw.githubusercontent.com/ItzApipAjalah/astro-app/main/public/images/project-template.png"
                    alt="Project Template Preview"
                    projectName="komikkuya"
                  />
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-xl font-semibold text-gray-800 dark:text-white">Komikkuya</h3>
                      <div className="flex space-x-2">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      This is a website for read manga/manhwa/manhua.
                    </p>
                    <div className="flex items-center justify-between">
                      <a href="http://komikkuya.my.id/" className="text-blue-600 dark:text-blue-400 hover:underline text-sm font-medium">View Project →</a>
                      <div className="flex space-x-2">
                        <a href="http://komikkuya.my.id/" className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200">
                          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg>
                        </a>
                      </div>
                    </div>
                ...
                >
                  <ProjectImage 
                    src="https://raw.githubusercontent.com/ItzApipAjalah/astro-app/main/public/images/project-template.png"
                    alt="Project Template Preview"
                    projectName="Donghua Stream"
                  />
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-xl font-semibold text-gray-800 dark:text-white">Donghua Stream</h3>
                      <div className="flex space-x-2">
                        <span className="px-2 py-1 text-xs font-medium bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 rounded-full">NextJS</span>
                        <span className="px-2 py-1 text-xs font-medium bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200 rounded-full">MTC</span>
                      </div>
                    </div>
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      This is a website for watch donghua/anime.
                    </p>
                    <div className="flex items-center justify-between">
                      <a href="https://donghua-stream.vercel.app/" className="text-blue-600 dark:text-blue-400 hover:underline text-sm font-medium">View Project →</a>
                      <div className="flex space-x-2">
                        <a href="https://donghua-stream.vercel.app/" className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200">
                          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg>
                        </a>
                      </div>
                    </div>
